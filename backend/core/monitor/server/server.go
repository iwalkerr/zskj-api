...
import (
	...
	ip2 "xframe/pkg/utils/ip"
	time2 "xframe/pkg/utils/time"
...
func Server(c *gin.Context) {
	...
	goStartTime := startTime.Format("2006-01-02 15:04:05") //启动时间

	goRunTime := time2.GetHourDiffer(goStartTime, time.Now().Format("2006-01-02 15:04:05")) //运行时长
	...
	resp.BuildTpl(c, "core/monitor/server/server").Write(gin.H{
		"cpuNum":          cpuNum,
		"cpuUsed":         cpuUsed,
		"cpuAvg5":         cpuAvg5,
		"cpuAvg15":        cpuAvg15,
