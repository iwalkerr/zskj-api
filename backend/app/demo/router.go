...
import (
	"xframe/backend/app/demo/form"
	"xframe/backend/app/demo/icon"
	"xframe/backend/app/demo/modal"
	"xframe/backend/app/demo/operate"
	"xframe/backend/app/demo/report"
	"xframe/backend/app/demo/table"
	"xframe/pkg/router"
)
